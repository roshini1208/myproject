...
const Homepage1 = () => {
  const backgroundImageUrl = 'url("https://i.pinimg.com/736x/ec/08/fe/ec08feb171dc7130264e615ad0cc36b1.jpg")';
  ...
  return (
    ...
    paddingUp: '2%'}}>
        ...
        <Button onClick={handle5}variant="outlined" style={{color:'black',borderColor:'black'}} ><h4>Primary</h4></Button>
        <br></br>
      </div>
